...
Unix Shell ist dasselbe wie Linux Shell, Terminal, Power Shell, Ubuntu Bash. Diese Bezeichnungen stehen für eine Mensch-Maschine Schnittstelle, in die Befehle eingegeben werden. https://de.wikipedia.org/wiki/Bash_(Shell)
Bild: Unix Shell:
