...
A-propos Copy/Paste: Ctrl + C und Ctrl + V funktioniert nicht in jedem Terminal. Dieses Problem kann mit dem Super-Tipp des Gastdozenten Stefan Meyer umgangen werden: Shift + Insert.
